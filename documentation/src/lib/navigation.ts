...
export const navigation: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: 'Onboarding Walkthrough', href: '/admin-guides/onboarding/overview' },
    ],
  },
  {
    title: 'Deployment',
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Google Calendar', href: '/admin-guides/whiteout-ai-connector/google-calendar' },
      { title: 'Outlook Mail', href: '/admin-guides/whiteout-ai-connector/outlook-mail' },
      { title: 'Outlook Calendar', href: '/admin-guides/whiteout-ai-connector/outlook-calendar' },
      { title: 'Microsoft Teams', href: '/admin-guides/whiteout-ai-connector/microsoft-teams' },
      ...
      { title: 'GitLab', href: '/admin-guides/whiteout-ai-connector/gitlab' },
      { title: 'Salesforce', href: '/admin-guides/whiteout-ai-connector/salesforce' },
      { title: 'HubSpot', href: '/admin-guides/whiteout-ai-connector/hubspot' },
      { title: 'Zoom', href: '/admin-guides/whiteout-ai-connector/zoom' },
      { title: 'Intercom', href: '/admin-guides/whiteout-ai-connector/intercom' },
    ],
  },
  {
